  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        suffixIcon: widget.labelText == 'Enter your Password' || widget.labelText == 'Confirm your Password'
            ? IconButton(
          icon: Icon(
      ...
      onChanged: (value) {
        if (widget.labelText == 'Enter your e-mail') {
          ...
          if (_passwordText != null) {
            _errorText = widget.validator?.validateConfirmPassword(_passwordText!, value);
          }
        } else {
          _errorText = null;
        }
